...
# Same input (iteration_30000 PLY + RDO-allocated NPZ) as 5k run.
# Output: iteration_40000/ (= 30000 + 10000), separate from iteration_35000/ (5k result).
for scene in bicycle garden stump room counter kitchen bonsai; do
  time=$(date +"%Y-%m-%d_%H:%M:%S")
  log="logs/qat10k_${scene}_${time}.log"
